...
export const FINISHED_HARNESS_MATERIAL_COLUMNS =
  'id,source_material_id,source_goods_id,platform_no,son_name,supplier_id,file_2d,packing_way,packing,son_unit,son_price_low,created_at,updated_at,supplier:suppliers(supplier_no)';
